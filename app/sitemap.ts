...
const pages: Array<{ path: string; priority: number; changefreq: MetadataRoute.Sitemap[number]["changeFrequency"] }> = [
  ...
  { path: "/boat-tour-dhermi-today/", priority: 0.82, changefreq: "daily" },
  { path: "/family-boat-tour-dhermi/", priority: 0.78, changefreq: "weekly" },
  { path: "/french-speaking-boat-tour-dhermi/", priority: 0.78, changefreq: "weekly" },
