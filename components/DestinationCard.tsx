...
export function DestinationCard({ destination }: { destination: Destination }) {
  ...
  return (
    <Link
      className="group block overflow-hidden rounded-lg border border-white/12 bg-white/6 text-pearl shadow-image"
    ...
    >
      <article className="relative min-h-[420px]">
        ...
        <div className="absolute inset-x-0 bottom-0 p-5 md:p-6">
          <div className="rounded-lg border border-white/18 bg-white/12 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-md">
            ...
            <p className="mt-3 text-sm leading-7 text-pearl/84">
