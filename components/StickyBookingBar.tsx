  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-md grid-cols-4 items-center gap-2">
        <a
          aria-label={enText("cta.heroWhatsapp")}
          className="inline-flex min-h-12 flex-col items-center justify-center gap-1 rounded-lg bg-ink px-2 text-[0.68rem] font-bold leading-none text-pearl shadow-sm"
        ...
        <a
          className="inline-flex min-h-12 flex-col items-center justify-center gap-1 rounded-lg border border-ink/12 bg-white px-2 text-[0.68rem] font-bold leading-none text-ink transition hover:border-ink/28 hover:bg-limestone"
